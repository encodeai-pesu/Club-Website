          ...
          <section className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mb-12 max-w-2xl text-lg font-mono leading-relaxed text-white">
                Organized by Encode AI, PES University.  
                Test your algorithmic thinking, teamwork, and speed across multiple
                competitive coding stages on the HackerRank platform.
              </p>
            ...
            <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
              <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="rounded-none border-2 border-white bg-black p-8 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  ...
                  <p className="font-mono text-sm text-white">PESU 52</p>
                </div>
                <div className="rounded-none border-2 border-white bg-black p-8 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
              ...
              <div className="mt-8 rounded-none border-2 border-white bg-black p-8 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                ...
                <ul className="space-y-4 font-mono text-sm text-white">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-bold text-[rgb(255,102,0)]">Preliminary Round :</span>
                      <span className="ml-1">Online on 8 March on HackerRank platform</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <div>
                      <span className="font-bold text-[rgb(255,102,0)]">Main Event & Finals :</span>
                      <span className="ml-1">Offline at venue on 14 March on HackerRank platform</span>
                    </div>
                  </li>
                </ul>
              </div>
