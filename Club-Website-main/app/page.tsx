          ...
          <section className="border-t-4 border-white bg-zinc-950">
            <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <div className="flex flex-col items-center text-center">
                  <div className="mb-6 h-40 w-40 rounded-none border-2 border-white bg-[rgb(255,102,0)] shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] overflow-hidden relative">
                    <Image 
                      src="/profile_pictures_optimized/Vinitha_U_S.webp" 
                      alt="Vinitha U S" 
                      fill
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="mb-6 h-40 w-40 rounded-none border-2 border-white bg-[rgb(255,102,0)] shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] overflow-hidden relative">
                    <Image 
                      src="/profile_pictures_optimized/Akshat_Tripathi.webp" 
                      alt="Akshat Tripathi" 
                      fill
                      className="object-cover"
                      sizes="160px"
