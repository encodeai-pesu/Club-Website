...
export default function Algomania2Page() {
  const images = [
    "/Algomania2/algo_2.0.JPG",
    "/Algomania2/algomania_2.0.jpg"
  ]
        ...
        <div className="min-h-screen bg-black">
          ...
          <section className="border-b-4 border-white">
            <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
              ...
              <h1 className="mb-6 text-5xl font-bold uppercase tracking-tight text-white lg:text-6xl">Algomania 2.0</h1>
              <p className="max-w-2xl text-lg font-mono leading-relaxed text-white">
                Encode.AI's competitive coding event held on 15th March 2025. It consisted of solving 20 coding questions in a given time, taking into consideration both speed and accuracy.
              </p>
            </div>
          </section>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {images.map((image, index) => (
                <div key={index} className="rounded-none border-2 border-white overflow-hidden shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                  <img src={image} alt={`Algomania 2.0 - ${index + 1}`} className="h-96 w-full object-cover" />
                </div>
              ))}
            </div>
          </section>
