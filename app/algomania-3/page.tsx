          ...
          <section id="about" className="border-t-4 border-white">
            <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
              ...
              <div className="mt-8 rounded-none border-2 border-white bg-black p-8 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                <h3 className="mb-4 text-2xl font-bold uppercase text-white">Event Schedule</h3>
                <ul className="space-y-4 font-mono text-sm text-white">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <div>
                      <span className="font-bold text-[rgb(255,102,0)]">Main Event (March 14):</span>
                      <span className="ml-1">Three competitive cycles with 3 rounds each (35-40 min/round). Teams compete in divisions and are reshuffled after each cycle based on global rankings.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <div>
                      <span className="font-bold text-[rgb(255,102,0)]">Finals:</span>
                      <span className="ml-1">Top 8 teams compete in 4 rounds (40 min/round) with higher difficulty problems.</span>
                    </div>
                  </li>
                </ul>
              </div>
              <div className="mt-8 rounded-none border-2 border-white bg-black p-8 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                <h3 className="mb-4 text-2xl font-bold uppercase text-white">Evaluation Criteria</h3>
                <p className="mb-4 font-mono text-sm leading-relaxed text-white">
                  Rankings are determined based on HackerRank scoring metrics:
                </p>
                <ul className="space-y-2 font-mono text-sm text-white">
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <span>Correctness of submitted solutions</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                  ...
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <span>Penalty rules as defined on HackerRank</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-none bg-[rgb(255,102,0)]" />
                    <span>Compliance with contest guidelines</span>
                  </li>
                </ul>
                <p className="mt-4 font-mono text-sm leading-relaxed text-white">
                  <span className="text-[rgb(255,102,0)] font-bold">Code of Conduct:</span> Maintain academic integrity. Malpractice, plagiarism, or unauthorized collaboration results in immediate disqualification.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="border-t-4 border-white bg-zinc-950">
            <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="rounded-none border-2 border-white bg-black p-8 text-center shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  <Users className="mx-auto mb-4 h-12 w-12 text-[rgb(255,102,0)]" />
                  <h3 className="mb-2 text-lg font-bold uppercase text-white">Krupa</h3>
                  <p className="mb-3 font-mono text-xs text-[rgb(255,102,0)]">CP Domain Head</p>
                  <p className="font-mono text-sm text-white">+91 86608 16801</p>
                </div>
                <div className="rounded-none border-2 border-white bg-black p-8 text-center shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
                  <Users className="mx-auto mb-4 h-12 w-12 text-[rgb(255,102,0)]" />
                  <h3 className="mb-2 text-lg font-bold uppercase text-white">Guruprasad</h3>
                  <p className="mb-3 font-mono text-xs text-[rgb(255,102,0)]">CP Domain Head</p>
                  <p className="font-mono text-sm text-white">+91 93807 80063</p>
                </div>
              </div>
